...
module SiteParts = 
    ...
    type ForgotPassTemplate = Templating.Template<"wwwroot/templates/forgotpass.html">
    ...
    type InactivityAdminTemplate = Templating.Template<"wwwroot/templates/inactivity_admin.html">
