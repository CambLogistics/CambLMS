...
module ActionDispatcher =
    let RunAction action arg postActionCallback =
        async {
            ...
            | ActionResult.InsufficientPermissions ->
                return Feedback.giveFeedback true "Nincs jogosultságod ehhez a művelethez!"
            | ActionResult.DatabaseError ->
                return Feedback.giveFeedback true "Adatbázishiba. Értesítsd a (műszaki) igazgatót!"
